...
class InterceptWaveBundleTest {
    ...
    fun `test all mockapi field messages exist`() {
        ...
        InterceptWaveBundle.message("mockapi.template")
        InterceptWaveBundle.message("mockapi.template.tooltip")
        InterceptWaveBundle.message("mockapi.template.apply")
        InterceptWaveBundle.message("mockapi.template.success")
        InterceptWaveBundle.message("mockapi.template.pagination")
        InterceptWaveBundle.message("mockapi.template.empty")
        InterceptWaveBundle.message("mockapi.template.error")
        InterceptWaveBundle.message("mockapi.template.auth.expired")
